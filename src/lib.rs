...
#[derive(Debug)]
pub struct RemixIDEProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RemixIDEProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RemixIDE processing");
    
    let mut processor = RemixIDEProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RemixIDEProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RemixIDEProcessor::new(false);
